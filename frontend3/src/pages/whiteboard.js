  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 p-6">
      <motion.div
        ...
        className="bg-gray-800 p-6 rounded-2xl shadow-xl w-full max-w-6xl"
      >
        ...
        <div className="flex items-center justify-center space-x-2 mb-4">
          <input
            ...
            className="flex-1 p-2 bg-gray-700  text-white rounded-lg max-w-4xl focus:ring-2 focus:ring-blue-500"
          />
          <button
        ...
        <div class="flex space-y-4 justify-center ">
          <div className="flex flex-col mt-5 ">
            {["black", "red", "blue", "green", "white"].map((col) => (
              <button
                ...
                className={`w-10 h-10 mb-5 rounded-full ${
                  col === "white" ? "border border-gray-500" : ""
                }`}
            ...
            <button
              className={`w-10 h-10 mb-5 rounded-full border border-gray-500`}
              style={{ background: "white" }} // Assuming canvas color is white
              onClick={() => setColor("white")} // Set color to match canvas background
            >
              Erase
            </button>
          </div>
          ...
          <div className="mt-4">
            <h3 className="text-white text-xl ml-4 font-semibold">
              Active Users:
            </h3>
